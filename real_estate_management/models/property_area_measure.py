...
class PropertyAreaMeasure(models.Model):
    ...
    length = fields.Float(string='Length(m)', help='The length of the room')
    width = fields.Float(string='Width(m)', help='The width of the room')
    height = fields.Float(string='Height(m)', help='The height of the room')
    area = fields.Float(string='Area(m²)', compute='_compute_area',
